...
db_connection();
$pageId = 'confirm_evaluation';
$pageTitle = 'Confirm Evaluation Page';

// Check unauthenticated access
if(@$_GET['code'] === $_SESSION['code'])
{
	$evaluationInfo = selectRow(array(), 'spcl_evaluation_score', "`teacher_id` = ".$_GET['tid']." AND `uid` = ".$_GET['uid']);
	...
	<div id="wrapper">
		...
		<div id="body" class="clear">
			...
			<div id="content" class="column-right">
				<?php include_once('../sources/student_content/confirm_evaluation_content.php'); ?>
			</div>
